...
def motif_map_se(
    ...
    pygr_station: Path = typer.Option(
        ...,
        "--pygr-station",
        "--pygrStation",
        help="FASTA root directory (was pygrStation, now genomedata root).",
    ),
...
def motif_map_a5ss(
    ...
    pygr_station: Path = typer.Option(..., "--pygr-station", "--pygrStation"),
    genome: str = typer.Option(..., "--genome"),
    output: Path = typer.Option(..., "--output", "-o"),
    rmats: str = typer.Option("NA", "--rMATS", "--rmats"),
    miso: str = typer.Option("NA", "--miso"),
