...
## rMATS
#
python ../motifMap.py -g hg19 -o PC3E.GS689.Li -r /media/bio/jwpark/work/motifTool/underDevelopment/testData/SE.MATS.ReadsOnTargetAndJunctionCounts.txt -mi NA -u NA -d NA -b NA --intron 250 --exon 50 --window 50 --step 2 --label "PC3E.vs.GS689.Li ESRP-like" -p /media/bio/data/pygr/ -m ../data/ESRP.like.motif.txt -k ../data/short.knownMotifs.human.mouse.txt 
python ../motifMap.py -g hg19 -o noOptionalMotifs.PC3E.GS689.Li -r /media/bio/jwpark/work/motifTool/underDevelopment/testData/SE.MATS.ReadsOnTargetAndJunctionCounts.txt -mi NA -u NA -d NA -b NA --intron 250 --exon 50 --window 50 --step 2 --label "PC3E.vs.GS689.Li ESRP-like" -p /media/bio/data/pygr/ -m NA -k ../data/short.knownMotifs.human.mouse.txt 
#
### running with MISO
#
## hg19
