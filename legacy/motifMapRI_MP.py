...
if __name__ == "__main__":
    # Legacy script entry point; prefer `python cli.py motif-map ri ...` instead.
    pass
...
def getCombinedCounts(exon):
    ...
    countPerWindow(rVal[2], exon[region[1]], 1, iLen)
    countPerWindow(rVal[3], exon[region[2]], 1, eLen)
    countPerWindow(rVal[4], exon[region[2]], -1, eLen)
...
def plotMotifs_finale(mapName, maxPointValue, maxNegPval, drawPoints,
    ...
    canv.writePDFfile(mapsPath + '/' + 'RI.' + mapName + '.pdf')
    ## write to PDF

    canv.writeGSfile(mapsPath + '/jj.png', "png16m", resolution=100)
    os.rename(mapsPath + '/jj.png', mapsPath + '/' + 'RI.' + mapName + '.png')
