...
if __name__ == "__main__":
    # Legacy script entry point; prefer `python cli.py motif-map a5ss ...` instead.
    pass
...
def getCombinedCounts(exon):
    ...
    countPerWindow(rVal[1], exon[region[0]], -1, eLen)
    countPerWindow(rVal[2], exon[region[1]], 1, eLen)
    countPerWindow(rVal[3], exon[region[1]], -1, eLen)
    countPerWindow(rVal[4], exon[region[2]], 1, iLen)
    countPerWindow(rVal[5], exon[region[3]], -1, iLen)
    countPerWindow(rVal[6], exon[region[4]], 1, eLen)
    countPerWindow(rVal[7], exon[region[4]], -1, eLen)
